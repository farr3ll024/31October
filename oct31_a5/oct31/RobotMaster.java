 ...
 *
 * The RobotMaster class acts as the go-between for the Robots and the other
 * parts of the warehouse. After each tick, the RobotMaster will check whether
 * there is an available idle Robot, and if so, send that Robot on a mission by
 * making calls to either Inventory or Orders.
 */
