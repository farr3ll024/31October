 ...
 *
 * The Robot class defines the individual robot. An new instance of Robot will
 * have a starting x coordinate "0" and some y coordinate less than the number
 * of robots in the warehouse. Robots will always be in one of two states: idle
 * (ready to be assigned a mission) or not idle (currently performing a mission)
 */
public class Robot {
